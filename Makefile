...
install:; forge install Openzeppelin/openzeppelin-contracts@v5.1.0 --no-commit && forge install dmfxyz/murky@v0.1.0 --no-commit  && forge install cyfrin/foundry-devops --no-commit 
